# Stalker Weapon Pack v3.7 (rel. 1.0) for IX-Ray Platform
...
2. **Platform-Specific Module** for each supported platform:
    - Call of Pripyat
    - Clear Sky

During installation, choose the platform-specific module you need.

| Version              | Platform       |
| -------------------- | -------------- |
| STCoP Weapon Pack 3.7| Call of Pripyat|
| STCS Weapon Pack 3.7 | Clear Sky      |
...
так и для оригинальной игры. Начиная с версии 3.7, оружейный пак использует модульную систему аддонов
